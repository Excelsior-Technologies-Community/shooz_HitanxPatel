  ...
  return (
    <div className="QuestionSection_container">
      <div className="container text-center">
        ...
        <p className="QuestionSection_title">GOT ANY QUESTIONS?</p>
        <p className="QuestionSection_subtitle mb-5">Use the form below to get in touch with the sales <br /> team</p>
